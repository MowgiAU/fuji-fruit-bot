...
window.loadCleanupData = async function() {
    const serverId = window.pluginHelpers.getCurrentServerId() || 
                    document.getElementById('cleanup-server-select')?.value;
    ...
    try {
        ...
        // Hide loading states
        window.pluginHelpers.hideLoading('cleanup-stats-container');
    }
};
...
window.loadEventServers = async function() {
    return await window.pluginHelpers.loadServers('event-server-select');
};

// Custom Commands Plugin helpers
window.loadCommandServers = async function() {
    return await window.pluginHelpers.loadServers('command-server-select');
};

// Link Tracking Plugin helpers
window.loadLinkTrackingServers = async function() {
    return await window.pluginHelpers.loadServers('linktracking-server-select');
};

// Channel Rules Plugin helpers
window.loadChannelRulesServers = async function() {
    return await window.pluginHelpers.loadServers('channelrules-server-select');
};

// Genre Discovery Plugin helpers
window.loadGenreDiscoveryServers = async function() {
    return await window.pluginHelpers.loadServers('genrediscovery-server-select');
};

// Migration Plugin helpers
window.loadMigrationServers = async function() {
