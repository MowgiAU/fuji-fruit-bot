// Define global variables and functions first
        ...
        function switchToPage(pageId) {
            ...
            navLinks.forEach(link => {
                ...
                if (linkPage === pageId) {
                    ...
                    console.log('Activated nav link:', linkPage);
                } else {
        ...
        function getMessagePluginComponent() {
            return {
                ...
                `,
                script: `
                    console.log('Loading message plugin...');
        ...
        function getWordFilterPluginComponent() {
            return {
                ...
                `,
                script: `
                    console.log('Loading word filter plugin...');
        ...
        async function loadPlugins() {
            try {
                ...
                if (messageContainer) {
                    ...
                    console.log('Message plugin HTML loaded');
                }
                ...
                if (wordFilterContainer) {
                    ...
                    console.log('Word filter plugin HTML loaded');
                }
                ...
                if (levelingContainer) {
                    ...
                    console.log('Leveling plugin HTML loaded');
                }
                ...
                if (channelRulesContainer) {
                    ...
                    console.log('Channel rules plugin HTML loaded');
                }
                ...
                setTimeout(() => {
                    try {
                        ...
                        console.log('Message plugin script executed');
                    } catch (error) {
                    ...
                    try {
                        ...
                        console.log('Word filter plugin script executed');
                    } catch (error) {
                        console.error('Error executing word filter plugin script:', error);
                    }
                    
                    try {
                        eval(levelingPlugin.script);
                        console.log('Leveling plugin script executed');
                    } catch (error) {
                        console.error('Error executing leveling plugin script:', error);
                    }
					try {
                        eval(channelRulesPlugin.script);
                        console.log('Channel rules plugin script executed');
                    } catch (error) {
        ...
        function setupNavigation() {
            ...
            document.addEventListener('click', function(e) {
                ...
                if (e.target.closest('.feature-card')) {
                    ...
                    console.log('Feature card clicked:', page);
                    switchToPage(page);
                    return;
                }
