...
class AutoRolePlugin {
    ...
    async handleReactionAdd(reaction, user) {
        try {
            ...
            // --- FIX START: Improved logic for max roles and role swapping ---
            if (reactionRoleData.maxRoles > 0) {
                ...
                if (memberReactionRoles.size >= reactionRoleData.maxRoles) {
                    // If the limit is 1, we assume the user wants to swap roles.
                    if (reactionRoleData.maxRoles === 1) {
                        ...
                        // If limit is > 1, prevent adding more and notify the user.
